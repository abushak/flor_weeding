...
<?php $order = $_Orders->AddOrder($_POST); ?>
...
<?php $html = $liqpay->cnb_form(array("version" => "3", "amount" => $_Orders->GetFinalPrice($order), "currency" => "UAH", "description" => WORD_59." №{$order}", "order_id" => "order_{$order}", "pay_way" => "card,liqpay", "result_url" => SRV_."order/success", "server_url" => SRV."adminside/bin/ajax.php?function=liqpay")); ?>
...
<div class="wbody done">
    ...
    <p><?php echo GetPaymentMethodDescription($_POST["payment_method"]); ?></p>
    <?php if ($_POST["payment_method"] == 1) { ?>
    ...
    <div style="width: <?php echo ($_POST["payment_method"] == 1) ? "540px" : "540px"; ?>;">
