...
<?php $query1=$mysql->query("SELECT COUNT(*) AS `total` FROM `zet_orders_products` WHERE `order_id`='82'");?>
<?php $total_products = $mysql->assoc($query1); ?>
<?php $cart_price = $_SESSION['price'] ; ?>
...
<div class="wbody order">
    ...
    <form action="<?php echo SRV_."userorder/confirm"; ?>" method="POST" class="left order_params" id="order-info-form">
        ...
        <div class="form">
            ...
            <div class="form-group">
                ...
                <div style="width:100%" class="input-group">
                    <div style="width:50%" class="group">
                        <div class="input"><span><?php echo WORD_88; ?></span><input name="door_address" /></div>
