...
<div class="pathway wbody">
    <ul>
        ...
        <li><a href="<?php echo SRV_."for_companies"; ?>"><?php echo $page['meta_h1']; ?></a></li>
    </ul>
</div>
...
<div class="company wmin">
    ...
    <div class="wimages wmin">
        <?php $query = $mysql->query("SELECT `file`,`title`,`description` FROM `zet_pages_static`,`zet_pages_static_description` WHERE `page_id`=`id` AND `language_id`='".$lang_id."' AND `parent`='2'"); ?>
