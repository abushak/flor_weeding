<section class="admin_all_order">
    <section class="row">
        <section class="admin_count_order"><?php echo WORD_191; ?></section>
        <section class="span4"><a class="add_order" href="<?php echo ADM_SRV.routesToLink(3, 2).'?act=add' ?>">+ <?php echo WORD_199; ?></a></section>
...
<section class="wrap_admin_table">
    <table class="admin_table brand">
        <?php include ADM_TPL."comments/reviews/caption.row.tpl"; ?>
        <?php include ADM_ROOT."modules/comments/reviews.list.php"; ?>
    </table>
</section>